...
int main(int argc, char *argv[]) {
  ...
  if (2 == argc) {
    ...
    if (header[44] != 'S' || header[45] != 'C' || header[46] != 'R' ||
        header[47] != 'M') {
    ...
    case 2:
      printf("Imago Orpheus %1X.%02X\n", header[41] & 0x0F, header[40]);
      break;

    case 3:
      printf("Impulse Tracker %1X.%02X\n", header[41] & 0x0F, header[40]);
      break;

    case 4:
      printf("Schism Tracker %1X.%02X\n", header[41] & 0x0F, header[40]);
      break;
    ...
    case 6:
      printf("BeRo Tracker %1X.%02X\n", header[41] & 0x0F, header[40]);
      break;

    case 7:
      printf("CreamTracker %1X.%02X\n", header[41] & 0x0F, header[40]);
      break;
    }
